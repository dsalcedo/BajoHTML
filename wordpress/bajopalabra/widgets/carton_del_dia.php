<?php
class widget_carton_del_dia extends WP_Widget
  {
    public function __construct()
        { parent::__construct(
            'widget_carton_del_dia',
            'Carton del dia',
            array( 'description' => 'Widget que contiene el cartón del día"' )
          );
        }
    public function form( $instance )
      {
        ...
        $title = isset($instance['title']) ? $instance['title'] : 'Carton del día';
        ?>
          <p>
            <label>
              Titulo del widget
    ...
    public function widget( $args, $ins )
      { 
      	$title = (isset($ins['title'])) ? esc_html($ins['title']) : 'Carton del día' ;
        ?>
		<div class="col-md-4">
...
add_action( 'widgets_init', create_function('', 'return register_widget("widget_carton_del_dia");') );
?>